...
export const map_pick_country_cities = /** @type {(inputs: Map_Pick_Country_CitiesInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Оберіть країну, щоб відкрити доступні міста й ресурси.`)
};
...
export const profile_share_text = /** @type {(inputs: Profile_Share_TextInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Заходь у GRABIT за моїм посиланням. Чат одразу, кроки й робота поруч.`)
};
...
export const pwa_open_app_steps = /** @type {(inputs: Pwa_Open_App_StepsInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Відкрийте застосунок. Крокомір на панелі — одразу рахувати кроки.`)
};
