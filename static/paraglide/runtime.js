 ...
 *   }
 */
export const locales = /** @type {const} */ (["ru","en","fr","es","zh","zh-TW","hi","ar","pt","de","ja","ko","it","tr","pl","uk","nl","vi","id","ms","th","fa","ur","bn","pa","sw","el","cs","ro","hu","sv","he"]);
/** @type {string} */
export const cookieName = "resursmap_lang";
/** @type {number} */
