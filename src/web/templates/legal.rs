...
pub fn render_rules() -> String {
    render_legal(
        ...
        &[
            ...
            "Шагомер считает шаги в вашем аккаунте. Цель дня — 10 000 шагов. Это подсказка, не медицинский прибор.",
...
pub fn render_privacy() -> String {
    render_legal(
        ...
        &[
            ...
            "В аккаунте остаются профиль, объявления, избранное, чат, шаги и настройки. Это нужно, чтобы после обновления страницы всё было на месте.",
            "Если включена почта, шлём код входа и сброс пароля. Telegram не обязателен.",
            "Напоминания про 10 000 шагов и поиск работы приходят в уведомления сайта. На телефоне — только если вы разрешили.",
